...
model.add(Conv2D(512, (3, 3), name="second"))
model.add(Activation('relu'))
model.add(MaxPooling2D(pool_size=(2, 2)))
model.add(Dropout(0.25))

model.add(Conv2D(512, (3, 3), padding='same', name="third"))
model.add(Activation('relu'))
model.add(Conv2D(512, (3, 3), name="fourth"))
model.add(Activation('relu'))
model.add(MaxPooling2D(pool_size=(2, 2)))
model.add(Dropout(0.25))
...
# plt.savefig('cifar10_cnn_noise_adam_3_layer.png')
#
# with open('cifar10_cnn_history_noise_adam_3_layer.json', 'w') as f:
#     json.dump(history.history, f)
#
# plot_model(model, to_file='cifar10_cnn_architecture_3_layer.png')
