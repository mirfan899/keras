...
hidden_layers = ["second", "third", "fourth", "fifth"]
...
plt.savefig('cifar10_cnn_noise_adam_5_layer.png')

print(history.history)

with open('cifar10_cnn_history_noise_adam_5_layer.json', 'w') as f:
    json.dump(history.history, f)

with open('test_cifar10_cnn_5_layer_noise_adam.json', 'w') as f:
    json.dump(scores, f)
